...
import { Covers } from '@/screen/claims/components/covers';
import { Requirement } from '@/screen/claims/components/requirement';
import { Status } from '@/screen/claims/components/status';
